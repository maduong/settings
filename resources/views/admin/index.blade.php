...
@section('content')
    <div class="layout-2columns sidebar-left">
        <div class="column left">
            <ul class="list-group">
                @php do_action(BASE_ACTION_META_BOXES, 'top-sidebar', EDUTALK_SETTINGS . '.index', null) @endphp
        ...
        <div class="column main">
            <div class="tab-content">
                @foreach(cms_settings()->export() as $key => $group)
                    ...
                    @endif
                @endforeach
                @php do_action(BASE_ACTION_META_BOXES, 'main', EDUTALK_SETTINGS . '.index', null) @endphp
            </div>
        </div>
    </div>
@endsection
